...
% \begin{itemize}
%     \item NCA favours $1$-NN and large scale linear projections
...
\begin{figure}
		 \centering
			  \subfigure[Simple NCA transformation]{\label{fig:sa-1}\includegraphics[width=0.45\textwidth]{images/sa-1}}
			    \hspace{0.02\textwidth}
			 \subfigure[NCA with dimensionality annealing projection]{\label{fig:sa-2}\includegraphics[width=0.45\textwidth]{images/sa-2}}
