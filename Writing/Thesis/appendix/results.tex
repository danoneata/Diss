...
\begin{figure}[h]
	  ...
	  \caption{Initialization experiments  on \texttt{iris} data set.}
	  \label{fig:iris-init}
\end{figure}
...
\begin{figure}
	  ...
	  \caption{Initialization experiments on \texttt{balance} data set.}
...
\begin{figure}
	  ...
	  \caption{Initialization experiments on \texttt{ecoli} data set.}
