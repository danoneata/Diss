...
\bottomrule
     \end{tabular}
     \caption{Accuracy scores of NCA trained using stochastic learning on small and medium sized data sets. The scores are averaged over 20 repeats. RCA was used for initialization.}
...
\begin{landscape}
  ...
  \begin{table}
    \centering\begin{tabular}{lrcccccc}
      ...
      \bottomrule
    \end{tabular}
  \caption{Accuracy scores for the compact support versions of NCA.}
