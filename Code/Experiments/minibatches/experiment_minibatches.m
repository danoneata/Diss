...
if ~isunix,
  root_path = 'D:\Diss\Results\minibatches-mnist\';
else
  root_path = '~/Documents/Diss/Results/minibatches-mnist/';
end
...
for repeat_ = 1:3,
  ...
  tic;
  [mapping, to_plot] = run_nca_minibatches('nca_obj_simple', X, c, d, [init m p lambda t0 max_iter]);
  total_time = toc;
