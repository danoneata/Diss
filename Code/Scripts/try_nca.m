...
fn1 = [dataset '-mapping.txt'];
fn2 = [dataset '-train-score.txt'];
fn3 = [dataset '-test-score.txt'];
fn4 = [dataset '-kdtree-contors.txt'];
...
fn5 = [dataset '-eucl-score.txt'];
if ~exist(fn5, 'file'),
  dlmwrite(fn5, [eucl_loocv_score eucl_kNN_score]);
end
